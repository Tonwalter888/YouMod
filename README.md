...
## How to contribute
1. Find or create an issue with the bug you're facing or a feature missing.
2. Clone the repository.
3. Make sure you're on the latest code and create a new branch for your changes
4. Implement your changes and ensure that they are well-tested, commit your changes and push your branch
5. Go to the original repository and create a new pull request (PR) from your branch.
    - In the PR description, reference the issue you're addressing (e.g., "Closes #123").
